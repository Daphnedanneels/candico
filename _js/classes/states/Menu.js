...
export default class Menu extends Phaser.State{
	create(){
		...
		this.waterBackground = this.game.add.sprite(0, 160, 'waterbackground');
		...
		this.playText = this.game.add.text(this.game.width/2, this.game.height/2, "SPEEL NU", { font: '24px CharlemagneStd-Bold', fill: '#DCB975' });
